...
\newcommand{\gruppennummer}{27} %Gruppennummer:
...
\newcommand{\semester}{SS25} %Semester:
\newcommand{\versuch}{Gamma Coincidence Spectroscopy} %Versuch:
\newcommand{\nameeins}{Julius Aichert} %Name1 (Vor und Nachname):
\newcommand{\emaileins}{uhoeb@student.kit.edu} %E-Mail 1:
\newcommand{\namezwei}{Martin Achtner} %Name2 (Vor und Nachname):
\newcommand{\emailzwei}{urrvl@student.kit.edu} %E-Mail 2:
\newcommand{\assistent}{Simon Gentner} %Assistent*in:
\newcommand{\durchfuehrungsdatum}{7.7.2025} %Durchgeführt am:
